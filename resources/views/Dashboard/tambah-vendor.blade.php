            ...
            <form method="POST" action="{{ route('vendor.store') }}">
                ...
                <div class="mb-6">
                    ...
                    <div class="flex items-center space-x-2" id="pic-row-template">
                        ...
                        <input type="number" name="pics[0][no_hp]" placeholder="No HP" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white w-1/4" required>
