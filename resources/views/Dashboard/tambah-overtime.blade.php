            ...
            <div class="container mx-auto p-4">
                ...
                <div>
                    <div class="flex items-center">
                        <div class="flex-grow">
                            <label for="search" class="block mb-1">Cari NRP TRAKNUS atau Nama</label>
                            <input type="text" id="search" class="bg-gray-50 border border-gray-300 rounded-lg p-2 w-full" placeholder="Cari pegawai">
                        </div>
                        <button id="clear-search" class="bg-red-500 text-white px-4 py-2 rounded-lg ml-2 mt-5">Hapus</button>
                    </div>
                ...
                <form id="overtime-form" action="{{ route('overtime.store') }}" method="POST">
                    ...
                    <div class="grid gap-4">
                        ...
                        <div>
                            <label for="request_date" class="block mb-1">Tanggal Lembur</label>
                            <input type="date" id="request_date" name="request_date" required class="bg-gray-50 border border-gray-300 rounded-lg p-2 w-full">
                        </div>
                        <div>
                            <label for="start-time" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Waktu Mulai:</label>
                            <div class="relative">
                        ...
                        <div>
                            <label for="end-time" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Waktu Selesai:</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 end-0 top-0 flex items-center pe-3.5 pointer-events-none">
                                    <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                                        <path fill-rule="evenodd" d="M2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10S2 17.523 2 12Zm11-4a1 1 0 1 0-2 0v4a1 1 0 0 0 .293.707l3 3a1 1 0 0 0 1.414-1.414L13 11.586V8Z" clip-rule="evenodd"/>
                        ...
                        <div>
                            ...
                            <textarea id="todo_list" name="todo_list" required class="bg-gray-50 border border-gray-300 rounded-lg p-2 w-full" placeholder="Tulisan aktivitas yang perlu dilakukan saat lembur"></textarea>
                        </div>
                    </div>

                    <!-- Submit Button -->
                    <div class="mt-6">
                        <button type="submit" class="bg-blue-700 hover:bg-blue-800 text-white p-2 rounded-lg w-full">Buat</button>
                    </div>
                </form>
            </div>
        </div>
