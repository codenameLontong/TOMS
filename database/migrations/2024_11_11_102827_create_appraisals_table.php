...
return new class extends Migration
{
    public function up()
    {
        Schema::create('appraisals', function (Blueprint $table) {
            ...
            $table->timestamp('created_at')->nullable(); // This field can be nullable if timestamps are disabled
            $table->string('appraisal_status'); // Adjust type as necessary
            $table->foreignId('id_appraisals_kategori')->constrained('appraisals_category'); // Foreign key, adjust related table name as needed
